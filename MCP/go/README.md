# Bajaj Allianz General Insurance Company Ltd. (BAGIC) MCP Server

This MCP (Model Content Protocol) server provides access to Bajaj Allianz General Insurance Company Ltd. (BAGIC) API functionality through HTTP, HTTPS, and STDIO transport modes.
